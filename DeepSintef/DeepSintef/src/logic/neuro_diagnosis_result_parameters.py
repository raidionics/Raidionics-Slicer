...
class NeuroDiagnosisParameters:
    ...
    def from_json(self, filename):
        ...
        self.tumor_multifocal = self.json_content['Overall']['Multifocality']
        self.tumor_parts = self.json_content['Overall']['Tumor parts nb']
        self.tumor_multifocal_distance = self.json_content['Overall']['Multifocal distance (mm)']
