...
class DiagnosisNeuroResultsWidget(qt.QWidget):
    ...
    def __setup_overall_results_area(self):
        ...
        self.results_ff_volumes_layout = qt.QHBoxLayout()
        self.results_ff_volumes_pat_label = qt.QLabel('FLAIR Changes volume (Patient):')
        self.results_ff_volumes_pat_lineedit = qt.QLineEdit()
        self.results_ff_volumes_pat_lineedit.setReadOnly(True)
        self.results_ff_volumes_mni_label = qt.QLabel('FLAIR Changes volume (MNI):')
        self.results_ff_volumes_mni_lineedit = qt.QLineEdit()
        self.results_ff_volumes_mni_lineedit.setReadOnly(True)
        self.results_ff_volumes_layout.addWidget(self.results_ff_volumes_pat_label)
        self.results_ff_volumes_layout.addWidget(self.results_ff_volumes_pat_lineedit)
        self.results_ff_volumes_layout.addWidget(self.results_ff_volumes_mni_label)
        self.results_ff_volumes_layout.addWidget(self.results_ff_volumes_mni_lineedit)
        self.results_status_groupbox_layout.addLayout(self.results_ff_volumes_layout)
        self.results_cav_volumes_layout = qt.QHBoxLayout()
        self.results_cav_volumes_pat_label = qt.QLabel('Cavity volume (Patient):')
        self.results_cav_volumes_pat_lineedit = qt.QLineEdit()
        self.results_cav_volumes_pat_lineedit.setReadOnly(True)
        self.results_cav_volumes_mni_label = qt.QLabel('Cavity volume (MNI):')
        self.results_cav_volumes_mni_lineedit = qt.QLineEdit()
        self.results_cav_volumes_mni_lineedit.setReadOnly(True)
        self.results_cav_volumes_layout.addWidget(self.results_cav_volumes_pat_label)
        self.results_cav_volumes_layout.addWidget(self.results_cav_volumes_pat_lineedit)
        self.results_cav_volumes_layout.addWidget(self.results_cav_volumes_mni_label)
        self.results_cav_volumes_layout.addWidget(self.results_cav_volumes_mni_lineedit)
        self.results_status_groupbox_layout.addLayout(self.results_cav_volumes_layout)
    ...
    def __update_results_gui(self):
        ...
        if "FLAIRChanges" in NeuroDiagnosisParameters.getInstance().structure_features.keys():
            self.results_ff_volumes_pat_lineedit.setText(str(round(NeuroDiagnosisParameters.getInstance().structure_features["FLAIRChanges"]['Patient'].volume, 2)) + ' ml')
            self.results_ff_volumes_mni_lineedit.setText(
                str(round(NeuroDiagnosisParameters.getInstance().structure_features["FLAIRChanges"]['MNI'].volume, 2)) + ' ml')
            self.results_ff_volumes_pat_label.setVisible(True)
            self.results_ff_volumes_pat_lineedit.setVisible(True)
            self.results_ff_volumes_mni_label.setVisible(True)
            self.results_ff_volumes_mni_lineedit.setVisible(True)
        else:
            self.results_ff_volumes_pat_label.setVisible(False)
            self.results_ff_volumes_pat_lineedit.setVisible(False)
            self.results_ff_volumes_mni_label.setVisible(False)
            self.results_ff_volumes_mni_lineedit.setVisible(False)
        if "Cavity" in NeuroDiagnosisParameters.getInstance().structure_features.keys():
            self.results_cav_volumes_pat_lineedit.setText(str(round(NeuroDiagnosisParameters.getInstance().structure_features["Cavity"]['Patient'].volume, 2)) + ' ml')
            self.results_cav_volumes_mni_lineedit.setText(
                str(round(NeuroDiagnosisParameters.getInstance().structure_features["Cavity"]['MNI'].volume, 2)) + ' ml')
            self.results_cav_volumes_pat_label.setVisible(True)
            self.results_cav_volumes_pat_lineedit.setVisible(True)
            self.results_cav_volumes_mni_label.setVisible(True)
            self.results_cav_volumes_mni_lineedit.setVisible(True)
        else:
            self.results_cav_volumes_pat_label.setVisible(False)
            self.results_cav_volumes_pat_lineedit.setVisible(False)
            self.results_cav_volumes_mni_label.setVisible(False)
            self.results_cav_volumes_mni_lineedit.setVisible(False)
